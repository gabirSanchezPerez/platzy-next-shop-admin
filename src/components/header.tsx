...
import { BellIcon, XCircleIcon, Bars4Icon } from "@heroicons/react/24/outline";
...
export default function Header() {
  ...
  const userData = {
    ...
    imageUrl: auth?.user?.avatar || `https://ui-avatars.com/api/?name=??`,
  };
  return (
    <>
              ...
              <div className="flex items-center justify-between h-16">
                ...
                <div className="-mr-2 flex md:hidden">
                  ...
                  <Disclosure.Button className="bg-gray-800 inline-flex items-center justify-center p-2 rounded-md text-gray-400 hover:text-white hover:bg-gray-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-gray-800 focus:ring-white">
                    ...
                    {open ? <XCircleIcon className="block h-6 w-6" aria-hidden="true" /> : <Bars4Icon className="block h-6 w-6" aria-hidden="true" />}
                  </Disclosure.Button>
                </div>
              </div>
            </div>
